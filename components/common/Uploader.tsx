...
const Uploader = ({ text, disabled, classNames }: Props) => {
  return (
    <div
      className={`flex flex-col items-center justify-center text-sm text-center text-primary-6 w-[106px] h-[106px] rounded-lg border border-solid border-primary-6 cursor-pointer bg-white
